                    ...
                    <div class="col-lg-8">
                        ...
                        <form class="row contact_form" action="./function/userCenterUpdate.php" method="get">
                            ...
                            <div class="col-md-12 form-group p_star">
                                用戶電話
                                <input placeholder="<?php if (isset($_SESSION['userPhone'])) {
                                      echo $_SESSION['userPhone'];
                                    } ?>" type="text" class="form-control" id="add1" name="userPhone" />
                            </div>
                            <div class="col-md-12 form-group p_star">
                                用戶密碼
                                <input placeholder="<?php if (isset($_SESSION['userPassword'])) {
                            ...
                            <div class="col-md-12 form-group p_star">
                                用戶生日
                                <input placeholder="<?php if (isset($_SESSION['userBirth'])) {
                                      echo $_SESSION['userBirth'];
                                    } ?>" type="date" class="form-control" id="city" name="userBirthday" />
                            </div>
